...
public class ThreeDeeRandom {
	public static void main(String[] args){
		PrintWriter writer = null;
		try {
			writer = new PrintWriter("udnsweRandom.ps");
		...
		ThreeDeeRandomizer pattern = new ThreeDeeRandomizer(writer);
		pattern.drawRandomPattern(1000);
		writer.close();
	}
}
